  ...
  <section class="container pb-4 pt-1 mb-5">
    ...
    <div class="row g-4">
      <div class="col-md-6">
        <div class="card bg-size-cover bg-position-center border-0 overflow-hidden h-100" style="background-image: url({{asset('front/assets/img/real-estate/recent/01.jpg')}});"><span class="img-gradient-overlay"></span>
      ...
      <div class="col-md-6">
        <div class="card bg-size-cover bg-position-center border-0 overflow-hidden mb-4" style="background-image: url({{asset('front/assets/img/real-estate/recent/02.jpg')}});"><span class="img-gradient-overlay"></span>
        ...
        <div class="card bg-size-cover bg-position-center border-0 overflow-hidden" style="background-image: url({{asset('front/assets/img/real-estate/recent/03.jpg')}});"><span class="img-gradient-overlay"></span>
          <div class="card-body content-overlay pb-0"><span class="badge bg-info fs-sm">New</span></div>
          <div class="card-footer content-overlay border-0 pt-0 pb-4">
            <div class="d-sm-flex justify-content-between align-items-end pt-5 mt-2 mt-sm-5"><a class="text-decoration-none text-light pe-2" href="real-estate-single-v1.html">
                <div class="fs-sm text-uppercase pt-2 mb-1">For sale</div>
  ...
  <section class="container mb-5 pb-2 pb-lg-4">
    <div class="row align-items-center">
      <div class="col-md-5"><img class="d-block mx-md-0 mx-auto mb-md-0 mb-4" src="{{asset('front/assets/img/real-estate/illustrations/calculator.svg')}}" width="416" alt="Illustration"></div>
  ...
  <section class="container mb-5 pb-2 pb-lg-4">
    ...
    <div class="tns-carousel-wrapper">
      <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 1, &quot;mode&quot;: &quot;gallery&quot;, &quot;controlsContainer&quot;: &quot;#agents-carousel-controls&quot;, &quot;nav&quot;: false}">
        <div>
          <div class="row align-items-center">
            <div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/01.jpg')}}" alt="Agent picture"></div>
            <div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/02.jpg')}}" alt="Agent picture"></div>
        ...
        <div>
          <div class="row align-items-center">
            <div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/02.jpg')}}" alt="Agent picture"></div>
            <div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/03.jpg')}}" alt="Agent picture"></div>
            <div class="col-xl-4 col-md-7 col-sm-8 px-4 px-sm-3 px-md-0 ms-md-n4 mt-n5 mt-sm-0 py-3">
              <div class="card border-0 shadow-sm ms-sm-n5">
                <blockquote class="blockquote card-body">
        ...
        <div>
          <div class="row align-items-center">
            <div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/03.jpg')}}" alt="Agent picture"></div>
            <div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="{{asset('front/assets/img/real-estate/agents/01.jpg')}}" alt="Agent picture"></div>
            <div class="col-xl-4 col-md-7 col-sm-8 px-4 px-sm-3 px-md-0 ms-md-n4 mt-n5 mt-sm-0 py-3">
              <div class="card border-0 shadow-sm ms-sm-n5">
                <blockquote class="blockquote card-body">

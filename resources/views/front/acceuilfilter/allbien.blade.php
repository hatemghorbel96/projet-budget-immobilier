    ...
    <div class="row g-0 mt-n3">
        ...
        <aside class="col-lg-4 col-xl-3 border-top-lg border-end-lg shadow-sm px-3 px-xl-4 px-xxl-5 pt-lg-2">
            <div class="offcanvas-lg offcanvas-start" id="filters-sidebar">
                ...
                <div class="offcanvas-body py-lg-4">
                    ...
                    <div class="pb-4 mb-2">
                        <h3 class="h6">Pour</h3>
                        <select class="form-select mb-2" id="for_filter">
                        ...
                        <div class="overflow-auto" data-simplebar data-simplebar-auto-hide="false"
                            ...
                            @foreach ($bientypes as $b)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="property_type"
                                        name="property_type" value="{{ $b->id }}">
        ...
        <div class="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
            ...
            <div class="row g-4 py-4" id="table_data">
                ...
                @include('front.acceuilfilter.ajax.listbien')
...
<script>
    ...
    function applyFilters() {
        ...
        var url = '{{ route('all.bien.acceuil.fetch') }}';
